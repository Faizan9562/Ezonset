...
import 'package:ezonset/View/Screens/About/contact_us.dart';
import 'package:ezonset/View/Screens/About/rate_us.dart';
import 'package:ezonset/View/Screens/About/tell_others.dart';
import 'package:ezonset/View/Screens/Auth/login.dart';
import 'package:ezonset/View/Screens/Notifications/notifications.dart';
import 'package:ezonset/View/Screens/Profile/profile.dart';
import 'package:ezonset/View/Screens/Settings/settings.dart';
import 'package:ezonset/View/Widgets/Buyer/buyer_home.dart';
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          ...
                          duration: Duration(milliseconds: 200),
                          curve: Curves.easeIn,
                          child: Settings(myUser: currentUser,),
                        ),
                      );
                    },
                  ),
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          ...
                          duration: Duration(milliseconds: 200),
                          curve: Curves.easeIn,
                          child: TellOthers(myUser: currentUser,),
                        ),
                      );
                    },
                  ),
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        PageTransition(
                          ...
                          duration: Duration(milliseconds: 200),
                          curve: Curves.easeIn,
                          child: ContactUs(myUser: currentUser,),
                        ),
                      );
                    },
                  ),
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          String _returnString = await _curruser.signOut();
