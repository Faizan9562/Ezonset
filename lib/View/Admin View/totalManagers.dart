...
class TotalManagers extends StatefulWidget {
  Map orgData;
  TotalManagers({this.orgData});

  _TotalManagersState createState() => _TotalManagersState();
}

class _TotalManagersState extends State<TotalManagers> {
  ...
  Widget build(BuildContext context) {
    ...
    List<QueryDocumentSnapshot> managerData;
    String orgPicture;
                ...
                return Column(
                  children: <Widget>[
                    ...
                    StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                          managerData = snapshot.data.docs;
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    NunitoText(
                                                      text:
                                                          "${managerData[index].data()["type"] == "Education" ? "Teacher" : "Manager"}",
                                                      fontWeight:
                                                          FontWeight.w500,
                                                      fontSize: 14,
                                                    ),
