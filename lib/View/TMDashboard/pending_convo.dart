...
class PendingConvo extends StatefulWidget {
  Map orgData;

  PendingConvo({this.orgData});
  @override
  _PendingConvoState createState() => _PendingConvoState();
}

class _PendingConvoState extends State<PendingConvo> {
